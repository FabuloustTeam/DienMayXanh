...
import Enum.Result;
import Pages.DMXViewProductThroughList;
...
public class ViewProductThroughList extends AbstractClass {
	...
	DMXViewProductThroughList objVPTL = new DMXViewProductThroughList();
	/**
	...
	public void testSuccessViewProductByList() throws Exception {
		...
		actual = objVPTL.compareTitle("Máy lọc nước RO hydrogen ion kiềm Kangaroo KG100EO 7 lõi");
